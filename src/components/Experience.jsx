...
const Experience = () => {
  return (
    <section
      id="experience"
      className="pt-6 pb-8 sm:py-20 bg-blue-50 dark:bg-gray-800 transition-colors duration-300 relative overflow-hidden"
    >
      ...
      <div className="text-center mb-4 sm:mb-16">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 to-blue-800 dark:from-white dark:to-blue-200 bg-clip-text text-transparent mb-0.5 xl:mb-2 sm:mb-6">
            Work - X
          </h2>
