...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="py-8 sm:py-20 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-800 dark:via-slate-800 dark:to-indigo-900 transition-all duration-500"
    >
